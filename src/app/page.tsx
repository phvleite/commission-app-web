    ...
    return (
        <main className="app-shell flex flex-1 items-center justify-center px-4 py-6 sm:px-6 sm:py-8 lg:px-6 lg:py-16">
            <section className="panel w-full max-w-6xl overflow-hidden">
                <div className="grid lg:min-h-[760px] lg:grid-cols-[1.15fr_0.85fr]">
                    ...
                    <div className="flex flex-col justify-center gap-6 bg-[var(--color-surface)] px-5 py-8 sm:px-8 sm:py-10 lg:gap-8 lg:px-12 lg:py-12">
                        <div>
                            <p className="gold-bar-title text-xs font-semibold tracking-[0.18em] text-[var(--color-primary)] uppercase sm:text-sm sm:tracking-[0.2em]">
                                Base da implantação web
                            </p>
                            <h2 className="mt-4 text-2xl font-semibold text-[var(--color-primary-strong)] sm:text-3xl">
                        ...
                        <div className="grid gap-4 sm:gap-5">
                            <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface-soft)]/50 p-4 sm:p-5">
                                <h3 className="text-base font-semibold text-[var(--color-primary-strong)] sm:text-lg">
                                    Cores oficiais
                                </h3>
                                <div className="mt-4 flex flex-wrap gap-2 sm:gap-3">
                                    <div className="flex items-center gap-2 rounded-full bg-white px-3 py-2 text-xs text-[var(--color-muted)] shadow-sm sm:text-sm">
                            ...
                            <div className="panel border-[var(--color-border)] p-4 sm:p-5">
                                <h3 className="text-base font-semibold text-[var(--color-primary-strong)] sm:text-lg">
                                    Stack da fundação
                                </h3>
                                <ul className="mt-4 space-y-2.5 text-sm leading-7 text-[var(--color-muted)] sm:space-y-3">
                        ...
                        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                            ...
                            <div className="inline-flex items-center rounded-xl border border-[var(--color-border)] px-5 py-3 text-sm text-[var(--color-muted)]">
